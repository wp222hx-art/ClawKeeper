# AGENT — Industry Analysis Lead

> id: `ipo_industry_analysis_lead`  ·  tier: `INDUSTRY_LEAD`  ·  category: `INDUSTRY_SAAS`

## Purpose

Coordinates industry-specific analysis with sector experts.
...
- `skills/ipo/industry-routing/SKILL.md`
