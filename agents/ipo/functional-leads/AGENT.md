# AGENT — Financial Diagnosis Lead

> id: `ipo_financial_diagnosis_lead`  ·  tier: `FUNCTIONAL_LEAD`  ·  category: `FINANCIAL`

## Purpose

Owns financial readiness diagnosis workstream.
...
- `skills/ipo/financial-diagnosis/SKILL.md`
