# AGENT — BioPharma Pipeline Evaluator

> id: `biopharma_pipeline_evaluator`  ·  tier: `WORKER`  ·  category: `INDUSTRY_BIOPHARMA`

## Purpose

Evaluates clinical pipeline (Phase I/II/III) success probability and risk.
...
- `skills/ipo/biopharma-pipeline/SKILL.md`
