# AGENT — BioPharma IP Analyzer

> id: `biopharma_ip_analyzer`  ·  tier: `WORKER`  ·  category: `INDUSTRY_BIOPHARMA`

## Purpose

Analyzes patent portfolio, freedom-to-operate, exclusivity windows.
...
- `skills/ipo/biopharma-ip/SKILL.md`
