# AGENT — BioPharma Clinical Disclosure Drafter

> id: `biopharma_clinical_disclosure_drafter`  ·  tier: `WORKER`  ·  category: `INDUSTRY_BIOPHARMA`

## Purpose

Drafts clinical-trial-result disclosures per ICH-GCP and SEC/HKEX rules.
...
- `skills/ipo/biopharma-clinical-disclosure/SKILL.md`
