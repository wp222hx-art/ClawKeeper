...
> id: `ipo_variance_analyst`  ·  tier: `WORKER`  ·  category: `FINANCIAL`

## Purpose

Period-over-period variance analysis with explanation drafts.
...
- `skills/ipo/variance-analysis/SKILL.md`
