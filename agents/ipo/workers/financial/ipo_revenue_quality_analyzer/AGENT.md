# AGENT — Revenue Quality Analyzer

> id: `ipo_revenue_quality_analyzer`  ·  tier: `WORKER`  ·  category: `FINANCIAL`

## Purpose

Tests revenue concentration, recognition timing, channel stuffing risk.
...
- `skills/ipo/revenue-quality/SKILL.md`
