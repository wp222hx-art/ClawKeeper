# AGENT — Working Capital Analyzer

> id: `ipo_working_capital_analyzer`  ·  tier: `WORKER`  ·  category: `FINANCIAL`

## Purpose

DSO/DPO/DIO cycles, working capital sensitivity.
...
- `skills/ipo/working-capital/SKILL.md`
