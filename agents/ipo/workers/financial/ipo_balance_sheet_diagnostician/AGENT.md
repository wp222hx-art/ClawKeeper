# AGENT — Balance Sheet Diagnostician

> id: `ipo_balance_sheet_diagnostician`  ·  tier: `WORKER`  ·  category: `FINANCIAL`

## Purpose

Diagnoses balance sheet: leverage, liquidity, asset quality.
...
- `skills/ipo/balance-sheet-diagnosis/SKILL.md`
