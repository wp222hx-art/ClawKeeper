# AGENT — Capital Efficiency Analyzer

> id: `ipo_capital_efficiency_analyzer`  ·  tier: `WORKER`  ·  category: `FINANCIAL`

## Purpose

ROIC, ROE, asset turnover analysis.
...
- `skills/ipo/capital-efficiency/SKILL.md`
