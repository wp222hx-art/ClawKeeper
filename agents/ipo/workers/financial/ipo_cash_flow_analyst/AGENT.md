...
> id: `ipo_cash_flow_analyst`  ·  tier: `WORKER`  ·  category: `FINANCIAL`

## Purpose

Reconciles operating, investing, financing cash flows; FCF normalization.
...
- `skills/ipo/cash-flow-analysis/SKILL.md`
