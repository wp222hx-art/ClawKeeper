# AGENT — Clean Energy Subsidy Tracker

> id: `cleanenergy_subsidy_tracker`  ·  tier: `WORKER`  ·  category: `INDUSTRY_CLEAN_ENERGY`

## Purpose

Tracks subsidy / IRA / tax-credit programs across jurisdictions.
...
- `skills/ipo/cleanenergy-subsidy/SKILL.md`
