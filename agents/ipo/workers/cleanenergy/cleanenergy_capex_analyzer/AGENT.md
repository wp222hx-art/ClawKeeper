# AGENT — Clean Energy Capex Analyzer

> id: `cleanenergy_capex_analyzer`  ·  tier: `WORKER`  ·  category: `INDUSTRY_CLEAN_ENERGY`

## Purpose

Analyzes capex schedules, capacity ramp curves, and unit economics.
...
- `skills/ipo/cleanenergy-capex/SKILL.md`
