# AGENT — Precedent Case Retriever

> id: `ipo_precedent_case_retriever`  ·  tier: `WORKER`  ·  category: `RAG`

## Purpose

Retrieves comparable IPO filings, comment-letter answers, and hearings.
...
- `skills/ipo/precedent-retrieval/SKILL.md`
