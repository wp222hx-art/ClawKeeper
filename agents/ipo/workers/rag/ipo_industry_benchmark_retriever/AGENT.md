# AGENT — Industry Benchmark Retriever

> id: `ipo_industry_benchmark_retriever`  ·  tier: `WORKER`  ·  category: `RAG`

## Purpose

Retrieves curated industry benchmark distributions (p10/25/50/75/90).
...
- `skills/ipo/benchmark-retrieval/SKILL.md`
