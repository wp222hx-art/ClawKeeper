# AGENT — Regulation Retriever

> id: `ipo_regulation_retriever`  ·  tier: `WORKER`  ·  category: `RAG`

## Purpose

Vector + BM25 retrieval over regulation knowledge base; returns cited chunks.
...
- `skills/ipo/regulation-retrieval/SKILL.md`
