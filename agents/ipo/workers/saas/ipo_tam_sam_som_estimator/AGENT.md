# AGENT — TAM/SAM/SOM Estimator

> id: `ipo_tam_sam_som_estimator`  ·  tier: `WORKER`  ·  category: `INDUSTRY_SAAS`

## Purpose

Estimates Total/Serviceable/Obtainable Addressable Market.
...
- `skills/ipo/market-sizing/SKILL.md`
