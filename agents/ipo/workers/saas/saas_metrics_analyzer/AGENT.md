# AGENT — SaaS Metrics Analyzer

> id: `saas_metrics_analyzer`  ·  tier: `WORKER`  ·  category: `INDUSTRY_SAAS`

## Purpose

Analyzes ARR/MRR/NRR/CAC/LTV/Magic Number against benchmarks.
...
- `saas_metric_analysis`

## Skills (loaded from)

- `skills/ipo/saas-metrics/SKILL.md`
