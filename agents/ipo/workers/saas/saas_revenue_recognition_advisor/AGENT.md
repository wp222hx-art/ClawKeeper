# AGENT — SaaS Revenue Recognition Advisor

> id: `saas_revenue_recognition_advisor`  ·  tier: `WORKER`  ·  category: `INDUSTRY_SAAS`

## Purpose

Advises on ASC 606 / IFRS 15 application for SaaS contracts.
...
- `skills/ipo/saas-revrec/SKILL.md`
