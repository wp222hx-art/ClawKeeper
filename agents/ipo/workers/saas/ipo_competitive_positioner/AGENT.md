# AGENT — Competitive Positioner

> id: `ipo_competitive_positioner`  ·  tier: `WORKER`  ·  category: `INDUSTRY_SAAS`

## Purpose

Maps the issuer against named competitors on key dimensions.
...
- `skills/ipo/competitive-positioning/SKILL.md`
