# AGENT — SaaS Cohort Analyzer

> id: `saas_cohort_analyzer`  ·  tier: `WORKER`  ·  category: `INDUSTRY_SAAS`

## Purpose

Builds cohort retention / expansion / churn analyses.
...
- `skills/ipo/saas-cohort/SKILL.md`
