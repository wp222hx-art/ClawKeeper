# AGENT — Safe Harbor Checker

> id: `sec_safe_harbor_checker`  ·  tier: `WORKER`  ·  category: `JURISDICTION_SEC`

## Purpose

Reviews forward-looking statements for PSLRA safe-harbor compliance.
...
- `skills/ipo/safe-harbor-check/SKILL.md`
