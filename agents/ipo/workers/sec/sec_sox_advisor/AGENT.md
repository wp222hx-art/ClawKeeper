# AGENT — SOX 404 Advisor

> id: `sec_sox_advisor`  ·  tier: `WORKER`  ·  category: `JURISDICTION_SEC`

## Purpose

Advises on SOX 302 / 404 compliance roadmap.
...
- `skills/ipo/sox-advisory/SKILL.md`
