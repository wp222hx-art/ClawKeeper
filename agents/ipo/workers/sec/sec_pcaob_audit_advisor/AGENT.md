# AGENT — PCAOB Audit Advisor

> id: `sec_pcaob_audit_advisor`  ·  tier: `WORKER`  ·  category: `JURISDICTION_SEC`

## Purpose

Translates PCAOB AS 2201 / 1105 into actionable audit-prep tasks.
...
- `skills/ipo/pcaob-advisory/SKILL.md`
