# AGENT — SEC Comment Letter Responder

> id: `sec_comment_responder`  ·  tier: `WORKER`  ·  category: `JURISDICTION_SEC`

## Purpose

Drafts cited responses to SEC staff comment letters.
...
- `comment_response_drafting`

## Skills (loaded from)

- `skills/ipo/comment-response/SKILL.md`
