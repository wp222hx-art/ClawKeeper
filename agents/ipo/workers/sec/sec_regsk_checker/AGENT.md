# AGENT — SEC Reg S-K Checker

> id: `sec_regsk_checker`  ·  tier: `WORKER`  ·  category: `JURISDICTION_SEC`

## Purpose

Verifies prospectus sections against Reg S-K item-by-item requirements.
...
- `regsk_compliance_check`

## Skills (loaded from)

- `skills/ipo/regsk-check/SKILL.md`
