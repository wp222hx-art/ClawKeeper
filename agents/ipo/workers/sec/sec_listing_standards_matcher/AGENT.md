# AGENT — SEC Listing Standards Matcher

> id: `sec_listing_standards_matcher`  ·  tier: `WORKER`  ·  category: `JURISDICTION_SEC`

## Purpose

Matches the issuer to Nasdaq GS/GM/CM or NYSE/NYSE American thresholds.
...
- `skills/ipo/listing-standards-match/SKILL.md`
