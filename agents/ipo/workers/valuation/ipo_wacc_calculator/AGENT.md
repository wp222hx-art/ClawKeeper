# AGENT — WACC Calculator

> id: `ipo_wacc_calculator`  ·  tier: `WORKER`  ·  category: `VALUATION`

## Purpose

Computes WACC with industry betas and country-risk premiums.
