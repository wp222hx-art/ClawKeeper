# AGENT — Precedent Transaction Analyzer

> id: `ipo_precedent_transaction_analyzer`  ·  tier: `WORKER`  ·  category: `VALUATION`

## Purpose

Builds precedent-M&A and precedent-IPO valuations.
...
- `precedent_tx_analysis`

## Skills (loaded from)

- `skills/ipo/precedent-tx/SKILL.md`
