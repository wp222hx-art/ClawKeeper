...
> id: `ipo_sensitivity_analyzer`  ·  tier: `WORKER`  ·  category: `VALUATION`

## Purpose

Builds tornado / one-way / two-way sensitivity tables.
...
- `skills/ipo/sensitivity/SKILL.md`
