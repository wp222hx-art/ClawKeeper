# AGENT — Comparable Company Valuator

> id: `ipo_comparable_company_valuator`  ·  tier: `WORKER`  ·  category: `VALUATION`

## Purpose

Builds public-company multiple-based valuations.
...
- `skills/ipo/comp-valuation/SKILL.md`
