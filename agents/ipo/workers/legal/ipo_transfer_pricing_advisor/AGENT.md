# AGENT — Transfer Pricing Advisor

> id: `ipo_transfer_pricing_advisor`  ·  tier: `WORKER`  ·  category: `TAX`

## Purpose

Advises on transfer pricing methods, documentation, BEPS alignment.
...
- `skills/ipo/transfer-pricing/SKILL.md`
