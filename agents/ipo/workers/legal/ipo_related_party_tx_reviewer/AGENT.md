# AGENT — Related Party Tx Reviewer

> id: `ipo_related_party_tx_reviewer`  ·  tier: `WORKER`  ·  category: `LEGAL`

## Purpose

Identifies and reviews related-party transactions per Item 404 / Ch.14A.
...
- `skills/ipo/related-party-review/SKILL.md`
