# AGENT — Use of Proceeds Drafter

> id: `ipo_use_of_proceeds_drafter`  ·  tier: `WORKER`  ·  category: `DISCLOSURE`

## Purpose

Drafts Use of Proceeds section consistent with valuation.
...
- `skills/ipo/use-of-proceeds/SKILL.md`
