# AGENT — Tax Treaty Analyzer

> id: `ipo_treaty_analyzer`  ·  tier: `WORKER`  ·  category: `TAX`

## Purpose

Analyzes applicable double-tax treaties and withholding rates.
...
- `skills/ipo/treaty-analysis/SKILL.md`
