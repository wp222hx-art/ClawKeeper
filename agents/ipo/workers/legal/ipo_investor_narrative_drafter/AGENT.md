# AGENT — Investor Narrative Drafter

> id: `ipo_investor_narrative_drafter`  ·  tier: `WORKER`  ·  category: `DISCLOSURE`

## Purpose

Drafts the equity story / roadshow narrative.
...
- `skills/ipo/narrative-drafting/SKILL.md`
