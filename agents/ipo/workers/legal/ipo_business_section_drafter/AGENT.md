# AGENT — Business Section Drafter

> id: `ipo_business_section_drafter`  ·  tier: `WORKER`  ·  category: `DISCLOSURE`

## Purpose

Drafts the Business / Description section of the prospectus.
...
- `skills/ipo/business-section/SKILL.md`
