# AGENT — Lockup Clause Analyzer

> id: `ipo_lockup_clause_analyzer`  ·  tier: `WORKER`  ·  category: `LEGAL`

## Purpose

Analyzes existing investor lock-up clauses; recommends underwriter lockup.
...
- `skills/ipo/lockup-analysis/SKILL.md`
