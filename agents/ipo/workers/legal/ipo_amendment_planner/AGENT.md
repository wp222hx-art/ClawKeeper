# AGENT — Amendment Planner

> id: `ipo_amendment_planner`  ·  tier: `WORKER`  ·  category: `DISCLOSURE`

## Purpose

Plans which sections need to be amended after each comment round.
...
- `skills/ipo/amendment-planning/SKILL.md`
