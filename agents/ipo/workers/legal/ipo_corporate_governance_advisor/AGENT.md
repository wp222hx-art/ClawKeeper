# AGENT — Corporate Governance Advisor

> id: `ipo_corporate_governance_advisor`  ·  tier: `WORKER`  ·  category: `LEGAL`

## Purpose

Recommends board composition, committees, charters per market rules.
...
- `skills/ipo/governance/SKILL.md`
