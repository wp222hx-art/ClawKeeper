# AGENT — ESG Metric Calculator

> id: `ipo_esg_metric_calculator`  ·  tier: `WORKER`  ·  category: `DISCLOSURE`

## Purpose

Calculates GHG, social, and governance metrics required by HKEX App.27.
...
- `skills/ipo/esg-metrics/SKILL.md`
