# AGENT — Cross-Border Tax Optimizer

> id: `ipo_cross_border_tax_optimizer`  ·  tier: `WORKER`  ·  category: `TAX`

## Purpose

Optimizes cross-border tax architecture using treaties.
...
- `skills/ipo/tax-optimization/SKILL.md`
