# AGENT — Risk Factors Drafter

> id: `ipo_risk_factors_drafter`  ·  tier: `WORKER`  ·  category: `DISCLOSURE`

## Purpose

Drafts comprehensive Risk Factors section.
...
- `skills/ipo/risk-factors/SKILL.md`
