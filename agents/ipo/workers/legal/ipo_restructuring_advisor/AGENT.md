# AGENT — Restructuring Advisor

> id: `ipo_restructuring_advisor`  ·  tier: `WORKER`  ·  category: `LEGAL`

## Purpose

Advises VIE / red-chip / direct structure trade-offs.
...
- `skills/ipo/restructuring/SKILL.md`
