# AGENT — Quarterly Filing Assistant

> id: `ipo_quarterly_filing_assistant`  ·  tier: `WORKER`  ·  category: `POST_IPO`

## Purpose

Assists with 10-Q / interim report preparation.
...
- `skills/ipo/quarterly-filing/SKILL.md`
