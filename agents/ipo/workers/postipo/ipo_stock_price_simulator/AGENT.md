# AGENT — Stock Price Simulator

> id: `ipo_stock_price_simulator`  ·  tier: `WORKER`  ·  category: `POST_IPO`

## Purpose

Runs Monte-Carlo / GARCH price-path simulations.
...
- `skills/ipo/price-simulation/SKILL.md`
