# AGENT — Roadshow Q&A Simulator

> id: `ipo_roadshow_qa_simulator`  ·  tier: `WORKER`  ·  category: `POST_IPO`

## Purpose

Generates probable investor questions and rehearsal answers.
...
- `roadshow_qa_simulation`

## Skills (loaded from)

- `skills/ipo/roadshow-qa/SKILL.md`
