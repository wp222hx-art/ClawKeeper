# AGENT — Lockup Period Tracker

> id: `ipo_lockup_period_tracker`  ·  tier: `WORKER`  ·  category: `POST_IPO`

## Purpose

Tracks lock-up release schedule and supply overhang risk.
...
- `skills/ipo/lockup-tracking/SKILL.md`
