# AGENT — HKEX Main Board Rules Checker

> id: `hkex_chapter_checker`  ·  tier: `WORKER`  ·  category: `JURISDICTION_HKEX`

## Purpose

Verifies eligibility under Main Board Listing Rules Ch. 8 / 9 / 11.
...
- `skills/ipo/hkex-rules-check/SKILL.md`
