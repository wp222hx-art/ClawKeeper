# AGENT — HKEX Sponsor Q&A Handler

> id: `hkex_sponsor_qa_handler`  ·  tier: `WORKER`  ·  category: `JURISDICTION_HKEX`

## Purpose

Drafts cited responses to HKEX hearing comments and post-hearing comments.
...
- `skills/ipo/hkex-qa-response/SKILL.md`
