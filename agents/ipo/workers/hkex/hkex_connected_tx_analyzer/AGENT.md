# AGENT — HKEX Connected Transaction Analyzer

> id: `hkex_connected_tx_analyzer`  ·  tier: `WORKER`  ·  category: `JURISDICTION_HKEX`

## Purpose

Identifies and quantifies connected transactions under Ch. 14A.
...
- `skills/ipo/hkex-connected-tx/SKILL.md`
