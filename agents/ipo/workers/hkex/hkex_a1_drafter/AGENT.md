# AGENT — HKEX A1 Drafter

> id: `hkex_a1_drafter`  ·  tier: `WORKER`  ·  category: `JURISDICTION_HKEX`

## Purpose

Drafts A1 application proof and listing document sections per Ch.11.
...
- `a1_drafting`
- `listing_doc_drafting`

## Skills (loaded from)

- `skills/ipo/hkex-a1-drafting/SKILL.md`

## Required Sign-offs Before Output is Final

LAWYER, AUDITOR, CFO, SPONSOR
