# AGENT — HKEX GEM Rules Checker

> id: `hkex_gem_checker`  ·  tier: `WORKER`  ·  category: `JURISDICTION_HKEX`

## Purpose

Verifies eligibility under GEM Listing Rules Ch. 11.
...
- `skills/ipo/hkex-gem-check/SKILL.md`
