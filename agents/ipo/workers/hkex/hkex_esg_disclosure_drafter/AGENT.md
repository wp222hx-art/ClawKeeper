# AGENT — HKEX ESG Disclosure Drafter

> id: `hkex_esg_disclosure_drafter`  ·  tier: `WORKER`  ·  category: `JURISDICTION_HKEX`

## Purpose

Drafts ESG report per HKEX Appendix 27 mandatory disclosures.
