# AGENT — Internal Control Monitor

> id: `ipo_internal_control_monitor`  ·  tier: `WORKER`  ·  category: `INTERNAL_CONTROL`

## Purpose

Continuous control monitoring and exception flagging.
...
- `skills/ipo/control-monitoring/SKILL.md`
