# AGENT — Walkthrough Documenter

> id: `ipo_walkthrough_documenter`  ·  tier: `WORKER`  ·  category: `INTERNAL_CONTROL`

## Purpose

Documents process walkthroughs with control points and risk linkage.
...
- `skills/ipo/walkthrough-documentation/SKILL.md`
