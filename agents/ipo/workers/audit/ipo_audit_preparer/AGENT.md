# AGENT — Audit Preparer

> id: `ipo_audit_preparer`  ·  tier: `WORKER`  ·  category: `AUDIT`

## Purpose

Prepares audit-ready trial balance, schedules, and supporting evidence.
...
- `skills/ipo/audit-preparer/SKILL.md`
