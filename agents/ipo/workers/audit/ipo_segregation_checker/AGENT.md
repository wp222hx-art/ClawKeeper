# AGENT — Segregation of Duties Checker

> id: `ipo_segregation_checker`  ·  tier: `WORKER`  ·  category: `INTERNAL_CONTROL`

## Purpose

Detects SoD conflicts in transactional system access.
