# AGENT — Workpaper Organizer

> id: `ipo_workpaper_organizer`  ·  tier: `WORKER`  ·  category: `AUDIT`

## Purpose

Organizes workpapers per audit-firm template; references PCAOB AS 1215.
...
- `skills/ipo/workpaper-organization/SKILL.md`
