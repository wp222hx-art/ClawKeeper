# AGENT — Materiality Calculator

> id: `ipo_materiality_calculator`  ·  tier: `WORKER`  ·  category: `AUDIT`

## Purpose

Computes overall materiality, performance materiality, and TE thresholds.
...
- `skills/ipo/materiality/SKILL.md`
