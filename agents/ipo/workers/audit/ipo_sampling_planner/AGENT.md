# AGENT — Sampling Planner

> id: `ipo_sampling_planner`  ·  tier: `WORKER`  ·  category: `AUDIT`

## Purpose

Plans audit sample sizes per AS 2315 / ISA 530.
...
- `skills/ipo/sampling-planning/SKILL.md`
