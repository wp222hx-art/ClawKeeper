# AGENT — ICFR Control Designer

> id: `ipo_icfr_designer`  ·  tier: `WORKER`  ·  category: `INTERNAL_CONTROL`

## Purpose

Designs entity-level + process-level controls; produces RACI / control matrix.
...
- `skills/ipo/icfr-design/SKILL.md`
