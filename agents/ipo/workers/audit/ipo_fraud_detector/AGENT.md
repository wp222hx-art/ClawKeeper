# AGENT — Fraud Indicator Detector

> id: `ipo_fraud_detector`  ·  tier: `WORKER`  ·  category: `INTERNAL_CONTROL`

## Purpose

Applies AS 2401 fraud risk factors to flag anomalies.
...
- `skills/ipo/fraud-detection/SKILL.md`
