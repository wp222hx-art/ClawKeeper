# AGENT — Deficiency Tracker

> id: `ipo_deficiency_tracker`  ·  tier: `WORKER`  ·  category: `AUDIT`

## Purpose

Tracks audit deficiencies and remediation status.
...
- `skills/ipo/deficiency-tracking/SKILL.md`
