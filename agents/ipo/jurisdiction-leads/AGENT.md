# AGENT — Jurisdiction Compliance Lead

> id: `ipo_jurisdiction_lead`  ·  tier: `JURISDICTION_LEAD`  ·  category: `JURISDICTION_SEC`

## Purpose

Routes work to SEC or HKEX teams based on target_market.
...
- `skills/ipo/jurisdiction-routing/SKILL.md`
