...
> Bound to agent: `ipo_corporate_governance_advisor` (Corporate Governance Advisor)

## When to use

Invoked by `ipo_corporate_governance_advisor` whenever its capabilities are routed:
- `governance_advisory`
