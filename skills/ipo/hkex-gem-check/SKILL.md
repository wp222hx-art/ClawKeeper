# SKILL — hkex-gem-check

> Bound to agent: `hkex_gem_checker` (HKEX GEM Rules Checker)

## When to use

Invoked by `hkex_gem_checker` whenever its capabilities are routed:
- `gem_rules_check`
