...
> Bound to agent: `saas_metrics_analyzer` (SaaS Metrics Analyzer)

## When to use

Invoked by `saas_metrics_analyzer` whenever its capabilities are routed:
