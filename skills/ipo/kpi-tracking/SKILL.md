...
> Bound to agent: `ipo_kpi_tracker` (KPI Tracker)

## When to use

Invoked by `ipo_kpi_tracker` whenever its capabilities are routed:
- `kpi_tracking`
