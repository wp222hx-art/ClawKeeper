...
> Bound to agent: `saas_revenue_recognition_advisor` (SaaS Revenue Recognition Advisor)

## When to use

Invoked by `saas_revenue_recognition_advisor` whenever its capabilities are routed:
- `revrec_advisory`
