...
> Bound to agent: `ipo_pl_diagnostician` (P&L Diagnostician)

## When to use

Invoked by `ipo_pl_diagnostician` whenever its capabilities are routed:
- `pl_diagnosis`
