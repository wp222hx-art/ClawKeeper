...
> Bound to agent: `saas_cohort_analyzer` (SaaS Cohort Analyzer)

## When to use

Invoked by `saas_cohort_analyzer` whenever its capabilities are routed:
- `cohort_analysis`
