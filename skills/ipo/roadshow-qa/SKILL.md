...
> Bound to agent: `ipo_roadshow_qa_simulator` (Roadshow Q&A Simulator)

## When to use

Invoked by `ipo_roadshow_qa_simulator` whenever its capabilities are routed:
