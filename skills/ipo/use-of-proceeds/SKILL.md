# SKILL — use-of-proceeds

> Bound to agent: `ipo_use_of_proceeds_drafter` (Use of Proceeds Drafter)

## When to use

Invoked by `ipo_use_of_proceeds_drafter` whenever its capabilities are routed:
- `proceeds_drafting`
