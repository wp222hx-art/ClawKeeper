...
> Bound to agent: `ipo_comparable_company_valuator` (Comparable Company Valuator)

## When to use

Invoked by `ipo_comparable_company_valuator` whenever its capabilities are routed:
- `comp_valuation`
