...
> Bound to agent: `ipo_dcf_modeler` (DCF Modeler)

## When to use

Invoked by `ipo_dcf_modeler` whenever its capabilities are routed:
- `dcf_modeling`
