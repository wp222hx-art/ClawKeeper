# SKILL — pcaob-advisory

> Bound to agent: `sec_pcaob_audit_advisor` (PCAOB Audit Advisor)

## When to use

Invoked by `sec_pcaob_audit_advisor` whenever its capabilities are routed:
- `pcaob_advisory`
