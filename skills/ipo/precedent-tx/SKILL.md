...
> Bound to agent: `ipo_precedent_transaction_analyzer` (Precedent Transaction Analyzer)

## When to use

Invoked by `ipo_precedent_transaction_analyzer` whenever its capabilities are routed:
