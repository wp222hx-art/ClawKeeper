...
> Bound to agent: `ipo_internal_control_lead` (Internal Control Lead)

## When to use

Invoked by `ipo_internal_control_lead` whenever its capabilities are routed:
- `icfr_design`
