# SKILL — audit-preparer

> Bound to agent: `ipo_audit_preparer` (Audit Preparer)

## When to use

Invoked by `ipo_audit_preparer` whenever its capabilities are routed:
- `audit_preparation`
