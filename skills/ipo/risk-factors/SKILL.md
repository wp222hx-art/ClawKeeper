...
> Bound to agent: `ipo_risk_factors_drafter` (Risk Factors Drafter)

## When to use

Invoked by `ipo_risk_factors_drafter` whenever its capabilities are routed:
- `risk_factors_drafting`
