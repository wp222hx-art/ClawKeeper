...
> Bound to agent: `ipo_segregation_checker` (Segregation of Duties Checker)

## When to use

Invoked by `ipo_segregation_checker` whenever its capabilities are routed:
- `sod_check`
