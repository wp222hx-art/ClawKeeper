# SKILL — sec-s1-drafting

> Bound to agent: `sec_s1_drafter` (SEC S-1 Drafter)

## When to use

Invoked by `sec_s1_drafter` whenever its capabilities are routed:
- `s1_drafting`
- `f1_drafting`
- `mdna_drafting`
