...
> Bound to agent: `ipo_materiality_calculator` (Materiality Calculator)

## When to use

Invoked by `ipo_materiality_calculator` whenever its capabilities are routed:
