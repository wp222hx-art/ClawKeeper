# SKILL — hkex-a1-drafting

> Bound to agent: `hkex_a1_drafter` (HKEX A1 Drafter)

## When to use

Invoked by `hkex_a1_drafter` whenever its capabilities are routed:
- `a1_drafting`
...
```ts
interface HkexA1DraftingOutput {
  summary: string;
  findings: Array<{
    category: string;
