...
> Bound to agent: `sec_sox_advisor` (SOX 404 Advisor)

## When to use

Invoked by `sec_sox_advisor` whenever its capabilities are routed:
- `sox_advisory`
