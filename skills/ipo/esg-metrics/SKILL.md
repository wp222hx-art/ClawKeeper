...
> Bound to agent: `ipo_esg_metric_calculator` (ESG Metric Calculator)

## When to use

Invoked by `ipo_esg_metric_calculator` whenever its capabilities are routed:
